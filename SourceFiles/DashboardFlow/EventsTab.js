      ...
      <View style={{flex: 1, backgroundColor: Colors.white}}>
        <View style={{marginVertical: 20}}>
          ...
          {Role == 'school' && index == 2 ? (
            <TouchableOpacity
              onPress={() => {
                navigate('AddMeeting', {isEdit: false});
              }}
              style={{
                alignSelf: 'flex-end',
                backgroundColor: '#ffffff',
          ...
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 6,
                height: 34,
                backgroundColor: index == 0 ? Colors.black : Colors.lightGrey01,
              }}>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 6,
                height: 34,
                backgroundColor: index == 1 ? Colors.black : Colors.lightGrey01,
              }}>
              <View style={styles.buttonContainer}>
                <Text
                  style={[
                    styles.buttonText,
                    {color: index == 1 ? Colors.white : Colors.lightGrey},
                  ]}>
                  Trainings
                </Text>
              </View>
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 6,
                height: 34,
                backgroundColor: index == 2 ? Colors.black : Colors.lightGrey01,
              }}>
              <View style={styles.buttonContainer}>
                <Text
                  style={[
                    styles.buttonText,
                    {color: index == 2 ? Colors.white : Colors.lightGrey},
                  ]}>
                  Meeting
                </Text>
              </View>
              ...
              return (
                <TouchableOpacity
                  ...
                  <View
                    ...
                    <Text
                      onPress={() => {
                        Linking.openURL(item?.training_link);
                      }}
                      numberOfLines={1}
                      style={{
                        fontSize: FontSize.FS_12,
