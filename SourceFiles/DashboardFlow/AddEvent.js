...
const AddEvent = (props) => {
	...
	const [EventData, setEventData] = useState(JSON.parse(props.route.params.eventData))
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.container}>
				...
				<View style={{marginHorizontal : 20, marginVertical : 20, borderRadius : 10, borderWidth : 1, borderColor : Colors.primaryRed,
					height : 200}}>
					...
					<View style={{ position : 'absolute', width : '100%'}}>
						...
						<TouchableOpacity style={{alignSelf : 'flex-end', backgroundColor : Colors.primaryRed, padding : 10,
				...
				<View style={{ marginHorizontal: 20, }}>
					...
					<Text style={{fontSize : FontSize.FS_14, color : Colors.primaryRed, fontFamily : ConstantKey.MONTS_MEDIUM, marginTop : 15}}>
						...
						<View style={{ flexDirection: 'row', marginTop: 10, }}>
							...
							<TouchableOpacity style={{ flexDirection: 'row', flex: 0.5 }}
								...
								<Icon name={EventType == 'announcement' ? 'dot-circle' : 'circle'} size={20} color={Colors.primaryRed} />
							...
							<TouchableOpacity style={{ flexDirection: 'row', flex: 0.5 }}
								...
								<Icon name={EventType == 'birthday' ? 'dot-circle' : 'circle'} size={20} color={Colors.primaryRed} />
								<Text style={{ marginLeft: 5, fontFamily: ConstantKey.MONTS_REGULAR, fontSize: FontSize.FS_16, color: Colors.black, }}>
									{i18n.t('birthday')}
								</Text>
							</TouchableOpacity>
						...
						{EventType == 'birthday' ?
							<>
								...
								<TouchableOpacity style={[styles.mobileView]} onPress={() => {
									...
									<Icon name={"chevron-down"} size={20} color={Colors.darkGrey} style={{ marginRight: 10 }} />
								</TouchableOpacity>
							</>
							: null}
					...
					<View style={styles.mobileView}>
						...
						<Icon name={"calendar-day"} size={20} color={Colors.darkGrey} style={{ marginLeft: 10,  }} />
					...
					<Text style={{fontSize : FontSize.FS_14, color : Colors.primaryRed, fontFamily : ConstantKey.MONTS_MEDIUM, marginTop : 15}}>
						Event Link <Text style={{color : Colors.darkGrey}}>( Optional )</Text>
					</Text>

					<View style={styles.mobileView}>

						<Icon name={"link"} size={20} color={Colors.darkGrey} style={{ marginLeft: 10,  }} />
					...
					<View style={{flexDirection : 'row', marginTop : 10, alignItems : 'center'}}>
							...
							<TouchableOpacity onPress={() => setIsPushNow(isPushNow == 0 ? 1 : 0)}>
								<Icon name={ isPushNow == 1 ? 'check-square' : 'square'} size={25} color={Colors.primaryRed}/>
							</TouchableOpacity>
...
{ /* User picker PopUp */}
				...
				>
					<View style={{ flexDirection: 'row', marginLeft: 20, marginRight: 20 }}>
						<Text style={{ flex: 1, fontSize: FontSize.FS_16, color: Colors.primaryRed, fontFamily: ConstantKey.MONTS_BOLD }}>
							{i18n.t('selectMember')}
						</Text>

						<TouchableOpacity>
							<Text style={{ fontSize: FontSize.FS_16, color: Colors.primaryRed, fontFamily: ConstantKey.MONTS_BOLD }}
						...
						renderItem={({ item, index }) => {
							return (
								<TouchableOpacity style={{
									...
									borderColor: SelectedUser == null ? Colors.darkGrey : (SelectedUser.id == item.id ? Colors.primaryRed : Colors.darkGrey), borderWidth: 1
								}}
									...
									{item.business_profile != null ?
										<Text style={{ marginTop: 10, fontSize: FontSize.FS_14, color: Colors.darkGrey, fontFamily: ConstantKey.MONTS_REGULAR, }}>
