...
const Login = props => {
  ...
  const requestCameraPermission = async () => {
    try {
      ...
      console.log(
        'READ_EXTERNAL_STORAGE permission result:',
						...
						{isLoading == false ?
							<TouchableOpacity style={{ alignSelf: 'center' }}>
								...
								<Text style={{
									...
									<Text style={{ color: Colors.primary, fontFamily: ConstantKey.MONTS_SEMIBOLD }}>{i18n.t('register')}</Text>
								</Text>
							</TouchableOpacity>
							: null}
